...
| **path-dont-match**  | RegEx         | path-dont-match=node_modules<br>path-dont-match="node_modules\|dist" | Informa ao `CLI` para ignorar a busca do termo quando<br>a RegEx for satisfeita.                                                                                                                                |
