...
class TestMessenger(unittest.TestCase):
  ...
  def test_process_text(self):
    self.assertEqual("[YELLOW]...[ENDC]pesetting industry. 123[YELLOW]...[ENDC]nknown printer took 123 a galley", messenger.process_text(self.regex, self.text_long))
    self.assertEqual(self.text, messenger.process_text(re.compile("Lorem Ipsum is"), self.text))
    self.assertEqual("Lorem Ipsum[YELLOW]...[ENDC]industry. 123 Lorem Ipsum[YELLOW]...[ENDC]er took 123 a galley", messenger.process_text(re.compile("Ipsum"), self.text_long))
    self.assertEqual("Lorem Ipsum is[YELLOW]...[ENDC]nown printer took 123 a galley", messenger.process_text(re.compile("Lorem Ipsum is"), self.text_long))
